...
class ROIRelationHead(torch.nn.Module):
    ...
    def forward(self, features, proposals, targets=None):
        ...
        """
        # Proposal -> (RelPN) -> Proposal pair
        #       \                   /                   object logit + proposal => (CE loss)
        #        \                 /                       /
        #      Proposal, Proposal pair -> (aGCN) -> object logit, pred logit, obj class, rel idx
        #                                                            /          /         /
        #                         -----------------------------------          -----------
        #                        /                                            /
        #                       /                 ----------------------------
        #                      /                 /
        #                      \     (obj class1, obj class2) -> (Freq Bias) -> pred logit
        #                       \                                                  /
        #                        ------------------------------------------------(+)
        #                                                                        /
        #                                                                    pred logit => [CE loss]
